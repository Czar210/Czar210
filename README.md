...
- **⚡ [Metis](https://github.com/Czar210/metis-backend):** An AI assistant for LoL with a full agentic RAG pipeline: hybrid search (KNN + BM25/RRF), intent routing, and reranking — all orchestrated via OpenRAG (Langflow + OpenSearch + Docling). Stack: Llama 3, FastAPI, Next.js.
